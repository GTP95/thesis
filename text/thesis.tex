...
\section{PEP Participant Login Portal (PEP PLP)}\label{pep_plp}\todo{link to old GitHub branch}
...
with a single build configuration intended to be built using ninja \todo{which in turns creates a CMake config?}. While there are different build targets, it is not modular enough
