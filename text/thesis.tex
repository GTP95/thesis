...
without having to use any special encoding.\todo{Maybe I should add more details about this?}\par
...
\begin{figure}[p]
	\includesvg[angle=90, scale=0.25]{data_access_failed_attempt}
	\centering
\end{figure}
