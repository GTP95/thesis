...
'irma' => array(
    'authirma:IRMA',
    'irma_api_server' => 'http://docker-irmaserver-1/sessions',
    'irma_web_server' => 'http://docker-irmaserver-1/irma',
    'jwt_privatekeyfile' => 'example.org.pem',
    'jwt_apiserver_publickeyfile' => 'apiserver-pk.pem',
    "issuer_id" => "PEP",
    "issuer_displayname" => "PEP",
